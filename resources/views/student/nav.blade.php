...
<nav class="navbar navbar-expand-md sticky-top navbar-light bg-success rounded">
  ...
  <a class="navbar-brand" href="{{route('studentDash')}}"><img src="{{asset('icon/exam.png')}}" style="height: 55px;"></a>
  ...
  <div class="collapse navbar-collapse" id="target">
    <ul class="navbar-nav mx-auto">
      ...
      <li class="nav-item dropdown d-none">
        <a href="#" class="nav-link dropdown-toggle btn-outline-info rounded text-white d-none" data-toggle="dropdown" data-target="dropdown_target pr-3">CONTACT US</a>
