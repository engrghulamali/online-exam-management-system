		...
		<div class="container">
			<div class="row">
				...
				<div class="col-9 col-sm-7  col-xs-6 col-md-9 rounded-right" style="background-color: #cfd8dc;">
					...
					<div class="container">
						<form action="/addquestion/{{$e->id}}" method="post">
              ...
              <div class="text-center">
                <button type="submit" class="btn btn-info btn-sx mr-2 mb-5 mt-3 text-uppercase" style="width: 150px;">Add Question</button>
              </div>
